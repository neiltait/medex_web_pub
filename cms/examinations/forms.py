...
class PrimaryExaminationInformationForm:
    ...
    def initialise_form_from_data(self, request):
        ...
        self.date_of_birth_not_known = True if "date_of_birth_not_known" in request else False
        ...
        self.date_of_death_not_known = True if "date_of_death_not_known" in request else False
